...
<section class="system-main">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Loja Virtual</li>
        </ol>
    </nav>
        <div class="container-main">
            ...
            <div class="mt-2">
                <form action="" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="name" placeholder="Nome da Aplicação" value="Peach Brasil"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="cnpj" placeholder="CNPJ" value="48498411498849" required
                            class="form-control required cnpj-mask">
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label"><strong>Palavras Chaves:</strong></label>
                        <textarea name="keywords" placeholder="Palavras Chaves" rows="5"
                            class="form-control ">criação de sites, lojas virtuais, identidade visual, redes sociais, gerenciamento google adwords, administração de sites, criação, sites, redes, sociais, lojas, virtuais, virtual, google adwords, gerenciamento, administracão</textarea>
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label"><strong>Descrição:</strong></label>
                        <textarea name="description" placeholder="Descrição" rows="5"
                            class="form-control ">Criação de Sites, Criação de Lojas Virtuais, Criação de Sites Dinâmicos, Logomarca, Anúncio Google (Adwords), Instagram (Posts)</textarea>
                    </div>
            ...
            <div class="cards-container mt-4 p-4 bg-white border">
                <div class="cards-view">
                    <a href="/admin/configuracoes/sistema/endereco/" title="Endereço">
                        <div class="card">
                            <h3 class="card-title">Endereço</h3>
                            <i class="fas fa-map-marker-alt text-danger"></i>
                        </div>
                    </a>
                    <a href="/admin/configuracoes/sistema/contato/" title="Contato">
                        <div class="card">
                            <h3 class="card-title">Contato</h3>
                            <i class="fas fa-phone-alt text-warning"></i>
                        </div>
                    </a>
                    <a href="/admin/configuracoes/sistema/sociais/"
                        title="Redes Sociais">
                        <div class="card">
                    ...
                    <a href="/admin/configuracoes/sistema/virtual/"
                        title="Loja Virtual">
                        <div class="card">
                    ...
                    <a href="/admin/configuracoes/sistema/lgpd/" title="LGPD">
                        <div class="card">
                            <h3 class="card-title">LGPD</h3>
                            <i class="fas fa-lock text-black"></i>
                        </div>
                    </a>
                    <a href="/admin/configuracoes/sistema/floater/" title="Floater">
                        <div class="card">
                            <h3 class="card-title">Floater</h3>
                            <i class="fas fa-exclamation-circle text-info"></i>
                        </div>
                    </a>
                    <a href="/admin/configuracoes/sistema/ftp/" title="FTP">
                        <div class="card">
